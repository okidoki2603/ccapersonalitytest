...
tech1 = input("I enjoy building and fixing items.") 

outdoor1 = input("I'll seriously go crazy if I don't go out of the house for the whole day.")

music1 = input("I think that I can see colours in my mind when i hear music.")

tech2 = input("I know how to build and operate apps and websites.")

outdoor2 = input("I'm good at building structures.")

music2 = input("I can play a musical instrument well.")

tech3 = input("I know how to edit or build codes.")
